...
export function EmbedSnippetBuilder({
  ...
  }, [slug, buttonText, accentColor, position, baseUrl]);
  ...
  return (
    <div>
      ...
      <p className="mt-4 text-[12px] leading-6 text-gray-400">
        Prefer to trigger it from your own button instead of the floating one?
        Add <code className="rounded bg-warm-border-soft px-1.5 py-0.5">data-gate-mode=&quot;manual&quot;</code>{" "}
        to the script tag, then put{" "}
        <code className="rounded bg-warm-border-soft px-1.5 py-0.5">data-gate-open=&quot;{slug}&quot;</code>{" "}
