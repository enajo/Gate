...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(47,107,79,0.16),transparent_30%),radial-gradient(circle_at_85%_18%,rgba(71,85,105,0.10),transparent_26%),linear-gradient(180deg,#F9FAFB_0%,#fafafa_44%,#f0f0ef_100%)] text-ink">
      <section className="mx-auto max-w-6xl px-4 py-10">
        {/* ── Hero card ───────────────────────────────────────────────────── */}
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[radial-gradient(circle_at_top_left,rgba(47,107,79,0.18),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.62),rgba(243,237,226,0.84))] p-8 shadow-warm-2xl">
        ...
        {hasActivity ? (
          ...
          <div className="relative mt-8 overflow-hidden rounded-[2.5rem] bg-[radial-gradient(circle_at_top_left,rgba(47,107,79,0.14),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.56),rgba(243,237,226,0.84))] p-10 text-center shadow-warm-xl">
