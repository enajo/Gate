...
function AuraButton({
  ...
  const styles = {
    ...
    gold:
      "border-brand-amber bg-[linear-gradient(135deg,#0e6e52,#2f9e73)] text-ink hover:brightness-[1.04]",
...
export default function MarketingHomePage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(14,110,82,0.16),transparent_28%),radial-gradient(circle_at_85%_22%,rgba(71,85,105,0.10),transparent_25%),linear-gradient(180deg,#F9FAFB_0%,#fafafa_28%,#f0f0ef_58%,#fbfbfb_100%)] text-ink">
      ...
      <section className="relative overflow-hidden px-4 py-16 text-center">
        <div className="mx-auto max-w-3xl">
          <div className="relative overflow-hidden rounded-section bg-[radial-gradient(circle_at_bottom_right,rgba(14,110,82,0.16),transparent_32%),linear-gradient(145deg,#1B1B1B_0%,#252525_45%,#171717_100%)] px-8 py-10 text-warm-cream shadow-[0_18px_50px_rgba(0,0,0,0.16)]">
            ...
            {pricingTiers.map((tier) => {
              ...
              return (
                <div
                  ...
                  className={
                    isPro
                      ? "relative overflow-hidden rounded-section bg-[radial-gradient(circle_at_top_left,rgba(14,110,82,0.18),transparent_34%),linear-gradient(145deg,#171717_0%,#282828_48%,#1B1B1B_100%)] px-7 py-8 text-warm-cream shadow-[0_18px_50px_rgba(0,0,0,0.18)] transition duration-500 ease-out hover:brightness-[1.03]"
      ...
      <section className="relative overflow-hidden px-4 pb-24">
        <div className="mx-auto max-w-5xl rounded-section border border-warm-border/80 bg-[linear-gradient(145deg,#f0f0ef_0%,#f0f0ef_54%,#fcfcfb_100%)] px-8 py-12 text-center shadow-[0_12px_34px_rgba(120,100,80,0.07)]">
          <h3
            style={{ fontFamily: "var(--font-display)" }}
