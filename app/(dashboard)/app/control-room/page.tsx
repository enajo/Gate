...
export default function ControlRoomPage() {
  ...
  if (isLoading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_50%_0%,rgba(14,110,82,0.16),transparent_30%),linear-gradient(180deg,#F9FAFB_0%,#fafafa_44%,#f0f0ef_100%)]">
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(14,110,82,0.16),transparent_30%),linear-gradient(180deg,#F9FAFB_0%,#fafafa_44%,#f0f0ef_100%)] text-ink">
        ...
        <div className="flex flex-col justify-between gap-6 border-b border-warm-border-soft pb-6 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-full border border-brand-amber bg-[linear-gradient(135deg,#0e6e52,#2f9e73)] px-5 text-[14px] text-ink transition hover:brightness-[1.04] disabled:opacity-60"
            >
              {isPublishing ? (
                <Loader2 className="mr-2 size-4 animate-spin" />
              ) : (
