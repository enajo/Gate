  ...
  return (
    <div className="space-y-2">
      {calendars.map((cal) => (
        <div
          key={cal.id}
          className="card-inner bg-white p-4"
        >
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={loading}
            className="flex size-8 items-center justify-center rounded-full border border-warm-border-soft text-gray-500 transition hover:border-ink disabled:opacity-40"
          >
      ...
      {!loading && calendars.length > 0 && (
        <p className="text-[11px] leading-5 text-gray-400">
          <strong className="text-gray-500">Conflict check</strong> — blocks slots when this
          calendar has an event. &nbsp;
          <strong className="text-gray-500">Default</strong> — where new booking events are
          created.
        </p>
      )}
    </div>
  ...
  return (
    <>
      ...
      <button
        ...
        className="group relative w-full overflow-hidden card-warm p-7 text-left transition duration-500 ease-out hover:-translate-y-1"
      >
        ...
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <CalendarDays className="size-4 text-brand-amber" />
              Calendar
            </DialogTitle>
            <DialogDescription>
